...
'Restarted Powershell with admin priviledges'
...
Clear-Host
Write-Output "  **This tool will attempt to remove bloatware and erase temp files across all user profiles. Please use with caution.**"
Write-Output ""
$ComputerOBJ = Get-ComputerName
Write-Output "You have entered $ComputerOBJ. Is this correct?"
Pause
Write-Output ""
